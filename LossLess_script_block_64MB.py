"""Lossless control experiment runner with block size 64MB."""
...
THREAD_COUNT = '4'
BLOCK_SIZE = str(64 * 1024 * 1024)
INPUT_DIR = '/media/compress/新加卷1/New_Test'
OUTPUT_DIR = '/media/compress/新加卷/output/New_Test_LossLess/FastqCA_block_64MB'
...
def main():
    ...
    csv_path = os.path.join(OUTPUT_DIR, f'compression_metrics_block_64MB_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv')
    header = [
