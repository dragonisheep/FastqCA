"""Lossless control experiment runner with block size 128MB."""
...
OUTPUT_DIR = '/media/compress/新加卷/output/New_Test_LossLess/FastqCA_block_128MB'
...
def main():
    ...
    csv_path = os.path.join(OUTPUT_DIR, f'compression_metrics_block_128MB_{datetime.now().strftime("%Y%m%d_%H%M%S")}.csv')
    header = [
